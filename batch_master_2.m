...
% --- RUN 1: High-Density Aligned (Pristine) ---
try
    fprintf('\n---> INITIATING RUN 1: ...\n');
    folder_1 = run_gnr_sweep('gnr_spacing', 0.2:0.6:3.8, ...                            
...
% --- RUN 2: Low-Defect Polydomain ---
try
    fprintf('\n---> INITIATING RUN 2: ...\n');
    folder_2 = run_gnr_sweep('gnr_spacing', 0.2:0.6:3.8, ...                            
...
% --- RUN 3: Low-Density Aligned (Pristine) ---
try
    fprintf('\n---> INITIATING RUN 3: ...\n');
    folder_3 = run_gnr_sweep('gnr_spacing', 0.2:0.6:3.8, ...                            
                             'apex_angle', 10:20:110, ...
                             'L_gap', 5:7.5:35, ...
                             1000, 'aligned', ...
                             'num_workers', num_workers, ...
...
% --- RUN 4: Moderate-Defect Polydomain ---
try
    fprintf('\n---> INITIATING RUN 4: ...\n');
    folder_4 = run_gnr_sweep('gnr_spacing', 0.2:0.6:3.8, ...                            
                             'apex_angle', 10:20:110, ...
                             'L_gap', 5:7.5:35, ...
                             1000, 'aligned', ...
                             'num_workers', num_workers, ...
